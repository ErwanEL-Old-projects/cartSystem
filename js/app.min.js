...
const github = (() => {
    ...
    switch (userLang) {
        case "es":
            console.log('Hola si le interesa ver el código check mi github aquí ------> https://github.com/ErwanEL/quizz-th/tree/gh-pages/js-no-minify')
            break;
        case "fr":
            console.log('Pour voir le code rendez vous sur mon github ------> https://github.com/ErwanEL/quizz-th/tree/gh-pages/js-no-minify')
            break;
        case "en":
            console.log('To see the code check mi github here ------> https://github.com/ErwanEL/quizz-th/tree/gh-pages/js-no-minify')
            break;
...
var github = function () {
    ...
    switch (userLang) {
      case "es":
        console.log('Hola si le interesa ver el código check mi github aquí ------> https://github.com/ErwanEL/cartSystem/blob/gh-pages/no-minify-js/cart.js');
        break;
  
      case "fr":
        console.log('Pour voir le code rendez vous sur mon github ------> https://github.com/ErwanEL/cartSystem/blob/gh-pages/no-minify-js/cart.js');
        break;
      ...
      default:
        console.log('Si le interesa ver el código check mi github aquí ------> https://github.com/ErwanEL/cartSystem/blob/gh-pages/no-minify-js/cart.js');
        break;
    }
  }();